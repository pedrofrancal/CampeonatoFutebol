...
@WebServlet("/quartasFinais")
public class ServletQuartasFinais extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ServletQuartasFinais() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/quartas_finais.jsp").forward(request, response);
	}
